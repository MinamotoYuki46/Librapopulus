                    ...
                    <div class="flex justify-start items-center flex-wrap gap-4 pt-8">
                        ...
                        ?>
                                ...
                                <button data-modal-target="report-modal" data-modal-toggle="report-modal"
                                    class="inline-flex items-center px-5 py-2.5 bg-red-500 text-white rounded-lg hover:bg-red-600 font-medium transition duration-200 ease-in-out shadow-md">
                                    <i class="fa-solid fa-flag mr-2"></i> Laporkan
                                </button>
        ...
        <div class="relative w-full max-w-md max-h-full m-auto">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                <button type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200
                    ...
                    dark:hover:text-white" data-modal-hide="report-modal">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Laporkan peminjaman ini?</h3>
                    <form action="<?= base_url('library/loan/report/' . $loan['id']) ?>" method="POST" class="space-y-4">
                        <?= csrf_field() ?>
                        <textarea name="report_reason" required rows="3"
                            placeholder="Alasan pelaporan..."
                            class="w-full p-2 border border-gray-300 rounded-lg text-sm focus:ring-red-500 focus:border-red-500 dark:bg-gray-600 dark:text-white"></textarea>
                        <div class="flex justify-center gap-4 pt-2">
                            <button type="submit"
                                class="bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg text-sm px-5 py-2.5">
                                Kirim Laporan
                            </button>
                            <button type="button" data-modal-hide="report-modal"
                                class="text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:outline-none
                                focus:ring-gray-200 rounded-lg text-sm font-medium px-5 py-2.5">
                                Batal
                            </button>
                        </div>
                    </form>
